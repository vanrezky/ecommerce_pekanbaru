...
$route['get_riwayat'] = 'web/riwayat';
$route['web/details/(:num)'] = 'web/riwayat_details/$1';
...
$route['manage/user'] = 'user/manage_user';
$route['save/user'] = 'user/save_user';
$route['delete/user/(:num)'] = 'user/delete_user/$1';
$route['edit/user/(:num)'] = 'user/edit_user/$1';
$route['update/user/(:num)'] = 'user/update_user/$1';
$route['published/user/(:num)'] = 'user/published_user/$1';
$route['unpublished/user/(:num)'] = 'user/unpublished_user/$1';

//Laporan Route List
$route['dashboard'] = 'admin/index';
$route['manage/laporan'] = 'laporan/manage_laporan';
$route['laporan/details/(:num)'] = 'laporan/order_laporan/$1';

$route['add/profil'] = 'profil/add_profil';
$route['save/user'] = 'user/save_user';
$route['delete/user/(:num)'] = 'user/delete_user/$1';
$route['edit/user/(:num)'] = 'user/edit_user/$1';
$route['update/user/(:num)'] = 'user/update_user/$1';
