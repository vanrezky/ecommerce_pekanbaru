...
class Laporan extends CI_Controller{
    ...
    public function manage_laporan(){
        $data= array();
        $data['all_manage_laporan_info'] =$this->Laporan_model->manage_laporan_info();
        $data['maincontent']= $this->load->view('admin/pages/manage_laporan',$data,true);
