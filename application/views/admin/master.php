...
<html lang="en">
    <head>
        ...
        <!-- start: Meta -->
        <meta charset="utf-8">
        <title>E-Commerce Grosir Pekanbaru</title>
        <meta name="description" content="Shop Admin Panel Dashboard">
        <meta name="author" content="irsyad">
        <meta name="keyword" content="E-Commerce Grosir Pekanbaru">
        <!-- end: Meta -->
        ...
        <!-- start: Favicon -->
        <link rel="shortcut icon" href="<?php echo base_url()?>assets/admin/img/bg-login.jpg">
        <!-- end: Favicon -->
        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="<?php echo base_url('dashboard')?>"><span>E-Commerce Grosir Pekanbaru</span></a>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="<?php echo base_url('manage/category')?>"><i class="icon-tasks"></i><span class="hidden-tablet"> Kategori</span></a></li>
                            
                            <li><a href="<?php echo base_url('manage/brand')?>"><i class="icon-list-alt"></i><span class="hidden-tablet"> Brand</span></a></li>
                            <li><a href="<?php echo base_url('manage/product')?>"><i class="icon-dashboard"></i><span class="hidden-tablet"> Product</span></a></li>
                            <!--<li><a href="<?php echo base_url('theme/option');?>"><i class="icon-align-justify"></i><span class="hidden-tablet"> Theme Option</span></a></li>-->
                            <li><a href="<?php echo base_url('manage/order');?>"><i class="icon-calendar"></i><span class="hidden-tablet"> Pesanan</span></a></li>
                            <li><a href="<?php echo base_url('manage/laporan')?>"><i class="icon-calendar"></i><span class="hidden-tablet"> Laporan</span></a></li>
                            <li><a href="<?php echo base_url()?>user"><i class="icon-user"></i><span class="hidden-tablet"> Manage Pemilik Toko</span></a></li>
                            <li><a href="<?php echo base_url('manage/slider')?>"><i class="icon-picture"></i><span class="hidden-tablet"> Slider</span></a></li>
