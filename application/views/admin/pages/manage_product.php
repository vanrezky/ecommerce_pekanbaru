...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('manage/product')?>">Manage Produk</a></li>
    </ul>

    <div class="row-fluid sortable">		
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>Manage Produk</h2>
                <div class="box-icon">
            ...
            &emsp;
            <p align="left">
                <a href="<?php echo base_url('add/product')?>" class="btn btn-primary"><i class="glyphicon glyphicon-plus glyphicon-white"></i> Tambah Produk</a>
              </p>
            <div id="result">
