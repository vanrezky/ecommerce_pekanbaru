...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <a href="<?php echo base_url('manage/order')?>" class="quick-button metro blue span2">
            ...
            <p>Orders</p>
            <span class="badge"><?php $jumlah = $this->db->get('tbl_order')->num_rows(); echo $jumlah?></span>
        </a>
        <a href="<?php echo base_url('manage/product')?>" class="quick-button metro green span2">
            <i class="icon-barcode"></i>
            <p>Products</p>
            <span class="badge"><?php $jumlah = $this->db->get('tbl_product')->num_rows(); echo $jumlah?></span>
        </a>
...
&emsp;
    <div class="row-fluid">
        ...
        <div class="span12 widget blue" onTablet="span7" onDesktop="span813">
