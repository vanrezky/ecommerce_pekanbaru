            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                        <?php 
                        $i=0;
                        foreach($all_manage_laporan_info as $single_order){
                            $i++;
                            ?>
                        <tr>
                            <td><?php echo $i;?></td>
                            ...
                            <td><?php echo $single_order->product_title?></td>
                            <td>RP <?php echo $this->cart->format_number($single_order->product_price)?></td>
