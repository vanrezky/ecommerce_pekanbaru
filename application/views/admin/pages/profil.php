...
<div id="content" class="span10">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <i class="icon-edit"></i>
            <a href="<?php echo base_url('add/brand')?>">Tambah Profil</a>
        </li>
    </ul>
                ...
                <form class="form-horizontal" action="<?php echo base_url('save/brand')?>" method="post">
                    <fieldset>
                        ...
                        <div class="control-group">
                            <label class="control-label" for="fileInput">Nama Profil</label>
                            <div class="controls">
                                <input class="span6 typeahead" name="brand_name" id="fileInput" type="text"/>
                            </div>
                        </div>          
                        <div class="control-group">
                            <label class="control-label" for="textarea2">Deskripsi Profi</label>
                            <div class="controls">
