        ...
        <div class="section group">
            <div class="col_1_of_4 span_1_of_4">
                ...
                <ul>
                    ...
                    <li><a href="#"><span>Cari!</span></a></li>
                   
                    <li><a href="<?php echo base_url()?>web/contact"><span>Kontak</span></a></li>
                </ul>
            </div>
            <div class="col_1_of_4 span_1_of_4">
            ...
            <div class="col_1_of_4 span_1_of_4">
                <h4>My account</h4>
                <ul>
                    <li><a href=<?php echo base_url()?>costumer/login>Sign In</a></li>
                    <li><a href="<?php echo base_url()?>web/cart">View Cart</a></li>
                </ul>
            </div>
            <div class="col_1_of_4 span_1_of_4">
                <h4>Contact</h4>
